            ...
            <div class="users">
                <table class="plan">
                    ...
                    <tr>
                        ...
                        <td>{{\Carbon\Carbon::parse($uzivatel->created_at)->format('d.m.Y H:i')}}</td>
                        <td>{{\Carbon\Carbon::parse($uzivatel->updated_at)->format('d.m.Y H:i')}}</td>
                        <td>{{$uzivatel->role}}</td>
                        <td>
                            <div class="form">
                                <div class="upravit">
                                    <a href="{{ route('uzivatel.edit', $uzivatel->id) }}">Upravit</a>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="form">
                                <form method="post" action="{{ route('uzivatel.delete') }}">
                                    @csrf
                                    @method('DELETE')
